...
const leb128_2 = __webpack_require__(/*! ./utils/leb128 */ "./node_modules/@dfinity/candid/lib/cjs/utils/leb128.js");
...
/***/ "./src/declarations/finalDemo/finalDemo.did.js":
/*!*****************************************************!*\
  !*** ./src/declarations/finalDemo/finalDemo.did.js ***!
  \*****************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./src/declarations/finalDemo/index.js":
/*!*********************************************!*\
  !*** ./src/declarations/finalDemo/index.js ***!
  \*********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "idlFactory": () => (/* reexport safe */ _finalDemo_did_js__WEBPACK_IMPORTED_MODULE_1__.idlFactory),
/* harmony export */   "canisterId": () => (/* binding */ canisterId),
/* harmony export */   "createActor": () => (/* binding */ createActor),
/* harmony export */   "finalDemo": () => (/* binding */ finalDemo)
/* harmony export */ });
...
/* harmony import */ var _finalDemo_did_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./finalDemo.did.js */ "./src/declarations/finalDemo/finalDemo.did.js");
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./finalDemo.did.js")._SERVICE>}
 */
 const createActor = (canisterId, options) => {
  ...
  return _dfinity_agent__WEBPACK_IMPORTED_MODULE_0__.Actor.createActor(_finalDemo_did_js__WEBPACK_IMPORTED_MODULE_1__.idlFactory, {
    agent,
    canisterId,
...
/**
 * A ready-to-use agent for the finalDemo canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./finalDemo.did.js")._SERVICE>}
 */
 const finalDemo = createActor(canisterId);
...
"use strict";
/*!*******************************************!*\
  !*** ./src/finalDemo_assets/src/index.js ***!
  \*******************************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _dfinity_agent__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @dfinity/agent */ "./node_modules/@dfinity/agent/lib/esm/index.js");
...
/* harmony import */ var _dfinity_candid_lib_cjs_idl__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @dfinity/candid/lib/cjs/idl */ "./node_modules/@dfinity/candid/lib/cjs/idl.js");
/* harmony import */ var _declarations_finalDemo__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../declarations/finalDemo */ "./src/declarations/finalDemo/index.js");
...
supportButton.addEventListener('click', async ()=> {
  ...
  let tmp = (0,_dfinity_candid_lib_cjs_idl__WEBPACK_IMPORTED_MODULE_2__.Variant)(VoteType.Against);
  
  let res = await _declarations_finalDemo__WEBPACK_IMPORTED_MODULE_3__.finalDemo.vote(content, tmp);
  voteForId.innerText = ' ';
})
...
againstButton.addEventListener('click', async ()=> {
  ...
  const content = voteForId.value.toString();
  let res = await _declarations_finalDemo__WEBPACK_IMPORTED_MODULE_3__.finalDemo.vote(content, VoteType.Against);
  voteForId.innerText = ' ';
})
...
receiptButton.addEventListener('click', async ()=> {
  ...
  let res = await _declarations_finalDemo__WEBPACK_IMPORTED_MODULE_3__.finalDemo.proposalResult(content);
  
  receiptButton.setAttribute('disabled', false);
  getReceiptById.innerHTML += res.Ok
  

})


idSection.append(_declarations_finalDemo__WEBPACK_IMPORTED_MODULE_3__.canisterId);
proposalButton.addEventListener('click', async ()=> {
  ...
  let res = await _declarations_finalDemo__WEBPACK_IMPORTED_MODULE_3__.finalDemo.createProposal(content, 0, 30);
...
getbyidButton.addEventListener('click', async ()=> {
  ...
  let res = await _declarations_finalDemo__WEBPACK_IMPORTED_MODULE_3__.finalDemo.getProposal(content);
...
showallButton.addEventListener('click', async ()=> {
  ...
  let result = await _declarations_finalDemo__WEBPACK_IMPORTED_MODULE_3__.finalDemo.getAllProrosal();
